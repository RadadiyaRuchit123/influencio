        ...
        <footer className="footer">
            <div className="footer-container">
                <div className="footer-grid">
                    ...
                    <div className="footer-col">
                        ...
                        <div className="footer-address">
                            <p>3020 Westheimer Rd. Santa<br />Ana, USA 47541</p>
                            <p>+(1) 1203 548697</p>
                ...
                <div className="footer-branding" ref={brandingRef}>
                    <h2 className={`branding-text text-white ${isBrandingVisible ? 'animate-scale' : ''}`}>Influencio</h2>
                </div>

                <div className="footer-bottom">
                    <p>© Copyright. All Rights Reserved by <a href="#">Omor</a> • Powered by <a href="#">Framer</a></p>
                </div>
            </div>
        </footer>
    );
